...
- Create Angular project with ng: `ng new sampleapplication.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`sampleapplication.client.esproj`).
